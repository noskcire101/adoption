...
const MainContentTitle = ({ ifHasData, title, guest }: Props) => {
  ...
  return (
    <>
      <div className="z-50 drop-shadow-[1px_1px_var(--tw-shadow-color)] items-center mx-auto max-w-[1680px] justify-between flex shadow-white bg-gradient-to-b from-white ...  py-5 px-4 md:px-[130px] text-center sticky top-[132px] min-[438px]:top-[77px] md:top-[65px] ...">
