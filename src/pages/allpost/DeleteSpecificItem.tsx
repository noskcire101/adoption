...
const DeleteSpecificItem = ({ isOpen, onClose, id }: Props) => {
  ...
  return (
    <>
      <section
        className="bg-gray-50/90  fixed top-0 left-0 right-0 bottom-0 z-20 flex justify-center"
        style={
          isOpen
      ...
      >
        <div className=" flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-sm  sm:p-8">
